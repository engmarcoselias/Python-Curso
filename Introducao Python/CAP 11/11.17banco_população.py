#11.16criação do banco de dados com a população dos estados brasileiros
import sqlite3
...
cursor.execute("""create table estados(id integer primary key autoincrement,nome text,população integer)""")
